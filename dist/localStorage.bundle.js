...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ getLocal)\n/* harmony export */ });\n/* harmony import */ var _pubsub__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pubsub */ \"./src/pubsub.js\");\n\n\nfunction storeLocal(obj) {\n  const { key } = obj;\n  const { value } = obj;\n  localStorage.setItem(key, value);\n}\n\nfunction getLocal() {\n  const key = localStorage.key(0);\n  const json = localStorage.getItem(key);\n  const obj = JSON.parse(json);\n  if (!(obj === null)) {\n    _pubsub__WEBPACK_IMPORTED_MODULE_0__[\"default\"].publish(\"set-local\", obj);\n  }\n}\n\n_pubsub__WEBPACK_IMPORTED_MODULE_0__[\"default\"].subscribe(\"store-local\", storeLocal);\n\n\n//# sourceURL=webpack://todo-list/./src/localStorage.js?");
